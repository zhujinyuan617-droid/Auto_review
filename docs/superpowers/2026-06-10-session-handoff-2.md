...
> **更正(2026-06-10 晚)**:本节五项已**全部实施并提交**(commits f1e0d14 / 4133b0e /
> 93384ad / 7bd70d9 / b838a8f,均在 feature/map-home;决策已并入 map spec §10)。
> 现状以 `desktop_app/README.md` 为准;下文保留为当时的拍板记录。
